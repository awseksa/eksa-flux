...
mtcilId: {{ .Values.global.nf.mtcilId | quote }}
nfId: {{ .Values.global.nf.nfId | quote }}
microSvcName: {{ default "mtcil-prometheus-alertmanager" .Values.fullnameOverride | quote }}
...
mtcilId: {{ .Values.global.nf.mtcilId | quote }}
nfId: {{ .Values.global.nf.nfId | quote }}
microSvcName: {{ default "mtcil-prometheus-server" .Values.fullnameOverride | quote }}
...
{{- define "promethues.metadata.annotatetmaasspec" -}}
{{- $specOffset := .specOffset -}}
{{- $nfService := .nfService -}}
{{- printf "mtcil.com/tmaas: '{" | indent (add $specOffset 0 | int) | trim -}}
